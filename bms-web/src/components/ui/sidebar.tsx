...
const SidebarMenuButton = React.forwardRef<
  ...
  React.ComponentProps<"button"> & {
    asChild?: boolean
    isActive?: boolean
    tooltip?: string | React.ReactElement | React.ComponentProps<any>
...
>(({ className, showIcon = false, ...props }, ref) => (
  ...
  >
    {showIcon && (
      <div className="flex h-4 w-4 rounded-md bg-sidebar" />
    )}
    <div className="h-4 flex-1 max-w-[--skeleton-width] rounded-md bg-sidebar" />
  </div>
))
...
>(({ defaultOpen = true, open, className, ...props }, ref) => {
  ...
  return (
    <div
      ...
      data-state={openValue ? "expanded" : "collapsed"}
      {...props}
    />
  )
})
