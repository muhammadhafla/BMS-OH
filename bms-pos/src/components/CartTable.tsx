...
const CartTable: React.FC<CartTableProps> = ({
  ...
  const startEditQuantity = useCallback(
    (item: CartItem) => {
...
// Memoized CartTable component for performance optimization
const CartTableMemo = memo(CartTable)
CartTableMemo.displayName = 'CartTable'

export default CartTableMemo
